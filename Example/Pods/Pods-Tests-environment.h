...
// OcastaFoundationCategories
#define COCOAPODS_POD_AVAILABLE_OcastaFoundationCategories
#define COCOAPODS_VERSION_MAJOR_OcastaFoundationCategories 0
#define COCOAPODS_VERSION_MINOR_OcastaFoundationCategories 1
#define COCOAPODS_VERSION_PATCH_OcastaFoundationCategories 0
